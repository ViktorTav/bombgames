...
export var PaymentMethod = /*#__PURE__*/function () {
  function PaymentMethod(name, image, url) {
    ...
    _classPrivateFieldSet(this, _id, PaymentMethod.id++);
...
_defineProperty(PaymentMethod, "id", 0);